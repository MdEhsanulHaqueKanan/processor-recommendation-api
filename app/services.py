# app/services.py (Final Version with Debugging)
...
def load_and_process_data(file_path: str) -> pd.DataFrame:
    ...
    try:
        ...
        # ====================================================================
        # --- DEBUGGING LINES TO CHECK DESIGNER NAMES ---
        # ====================================================================
        unique_designers = df_processed['Designer'].unique().tolist()
        print("DEBUG: All unique designers in the dataset are:", unique_designers)
        # ====================================================================
...
def get_recommendations(requirements: Dict[str, Any], data: pd.DataFrame) -> pd.DataFrame:
    ...
    # This is the key change: Only filter by designer if it's not 'All'
    designer_req = requirements.get('designer')
    if designer_req and designer_req.lower() != 'all':
        filtered_df = filtered_df[filtered_df['Designer'].str.lower() == designer_req.lower()]
    ...
    # The display and renaming logic also remains the same
